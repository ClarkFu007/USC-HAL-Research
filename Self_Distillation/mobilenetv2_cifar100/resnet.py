...
class ResNet(nn.Module):
    ...
    def __init__(self, block, layers, num_classes=100, zero_init_residual=False,
        ...
        self.layer1 = self._make_layer(block, 64, layers[0])  # block, planes, blocks
