...
def fetch_dataloader(types, params):
    ...
    if params.dataset == 'cifar10':
        trainset = torchvision.datasets.CIFAR10(root='/home/yaof/data/cifar10/', train=True,
                                                download=True, transform=train_transformer)
        devset = torchvision.datasets.CIFAR10(root='/home/yaof/self_distill/data/cifar10/', train=False,
    ...
    # ************************************************************************************
        ...
        trainset = torchvision.datasets.SVHN(root='/home/yaof/data/SVHN/', download=True,
        ...
        transform_test = transforms.Compose([
            ...
            transforms.ToTensor(),
            transforms.Normalize(mean, std)])
        devset = torchvision.datasets.SVHN(root='/home/yaof/data/SVHN/', split='test',
                                           download=True, transform=transform_test)

    elif params.dataset == 'cifar100':
        trainset = torchvision.datasets.CIFAR100(root='/home/yaof/data/cifar100/', train=True,
                                                 download=True, transform=train_transformer)
        devset = torchvision.datasets.CIFAR100(root='/home/yaof/self_distill/data/cifar100/', train=False,
                                               download=True, transform=dev_transformer)
