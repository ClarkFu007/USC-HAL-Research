...
def main(args):
    ...
    torch.backends.cudnn.enabled = False  # Original: True
...
if __name__ == "__main__":
    ...
    parser.add_argument('--total_n_pseudo_batches', type=float, default=50000)
    ...
    parser.add_argument('--student_learning_rate', type=float, default=0.1)
    ...
    parser.add_argument('--teacher_architecture', type=str, default='WRN-50-2')
    parser.add_argument('--student_architecture', type=str, default='WRN-18-2')
    ...
    parser.add_argument('--pretrained_models_path', nargs="?", type=str,
                        default='/home/yaof/adv_prop/saved_models/model_best.pth.tar')

    parser.add_argument('--datasets_path', type=str,
                        default="/home/yaof/self_distill/data/cifar10")

    parser.add_argument('--log_directory_path', type=str,
                        default="/home/yaof/zero_shot/ZeroShotKnowledgeTransfer/logs")
    parser.add_argument('--save_final_model', type=str2bool, default=0)
    parser.add_argument('--save_n_checkpoints', type=int, default=0)
    parser.add_argument('--save_model_path', type=str, default="/home/yaof/zero_shot/FewShotKT/logs")
    ...
    args.log_freq = max(1, int(args.total_n_pseudo_batches / 200))  # The frequency of logs
