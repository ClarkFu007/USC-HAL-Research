    ...
    def forward(self, x):
        ...
        if training:
            ...
            if self.mixbn:
                ...
                return self._forward_impl(images).view(2, input_len, -1).transpose(1, 0)
            else:
                return self._forward_impl(images)
        else:
            images = x
...
def wide_resnet18_2(pretrained=False, progress=True, **kwargs):
    ...
    return _resnet(arch='wide_resnet16_2', block=Bottleneck, layers=[2, 2, 2, 2],
...
def wide_resnet50_2(pretrained=False, progress=True, **kwargs):
    ...
    """
    kwargs['width_per_group'] = 64 * 2
    return _resnet(arch='wide_resnet50_2', block=Bottleneck, layers=[3, 4, 6, 3],
                   pretrained=pretrained, progress=progress, **kwargs)
