...
if __name__ == "__main__":
    ...
    parser.add_argument('--pretrained_models_path', nargs="?", type=str,
                        default='/home/yaof/AdvProp/saved_models/model_best.pth.tar')

    parser.add_argument('--datasets_path', type=str,
                        default="/home/yaof/apex/deep_dream/cache/data/")

    parser.add_argument('--log_directory_path', type=str,
                        default="/home/yaof/ZeroShot/ZeroShotKnowledgeTransfer/logs")
    parser.add_argument('--save_final_model', type=str2bool, default=0)
    parser.add_argument('--save_n_checkpoints', type=int, default=0)
    parser.add_argument('--save_model_path', type=str, default="/home/yaof/ZeroShot/FewShotKT/logs")
