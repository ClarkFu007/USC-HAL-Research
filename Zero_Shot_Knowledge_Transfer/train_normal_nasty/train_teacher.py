...
parser.add_argument('--data', type=str, default='/home/yaof/train_teacher/data/cifar10/')
parser.add_argument('--output_dir', type=str, default='/home/yaof/train_teacher/trained_models/')
parser.add_argument('--teacher_name', type=str, default='WRN50-2', help='the name of the teacher network')
...
if args.dataset == 'cifar10':
    ...
    if args.teacher_name == 'Res50':
        net = resnet_teacher.ResNet50().cuda()

    if args.teacher_name == 'WRN50-2':
        net = wresnet_cifar.WideResNet(depth=50, num_classes=10, widen_factor=2, dropRate=0.0).cuda()
