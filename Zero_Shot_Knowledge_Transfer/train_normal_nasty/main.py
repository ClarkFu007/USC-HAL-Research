...
def main(args):
    ...
    """
       cuDNN should speed up the training time. Also if you set 
    torch.backends.cudnn.benchmark = True, cuDNN will use some 
    heuristics at the beginning of your training to figure out 
    which algorithm will be most performant for your model architecture 
    and input.
    """
...
if __name__ == "__main__":
    ...
    parser.add_argument('--batch_size', type=int, default=128,
                        help='for each iteration of N, sample one batch of input z') # 128
    ...
    parser.add_argument('--teacher_architecture', type=str, default='ResNet34_nor_nasty')
    ...
    args.device = 'cuda:1' if args.use_gpu else 'cpu'
