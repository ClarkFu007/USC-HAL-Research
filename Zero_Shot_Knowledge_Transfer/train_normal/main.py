...
if __name__ == "__main__":
    ...
    parser.add_argument('--total_n_pseudo_batches', type=float, default=10000) # cifar10 50000
    ...
    parser.add_argument('--teacher_architecture', type=str, default='Res34_normal')
    parser.add_argument('--student_architecture', type=str, default='Res18')
    ...
    parser.add_argument('--pretrained_models_path', nargs="?", type=str,
                        default='/home/yaof/trained_models/res34_normal_teacher_cifar10')
