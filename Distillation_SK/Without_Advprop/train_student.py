...
def parse_option():
    ...
    parser.add_argument('--model_s', type=str, default='wrn_16_2',
                        choices=['resnet8', 'resnet14', 'resnet20', 'resnet32', 'resnet44',
                                 ...
                                 'wrn_16_1', 'wrn_16_2', 'wrn_40_1', 'wrn_40_2', 'wrn_50_2',
                                 'resnet50', 'resnet38', 'resnet26',
                                 'vgg8', 'vgg11', 'vgg13', 'vgg16', 'vgg19', 'ResNet50',
                                 'MobileNetV2', 'ShuffleV1', 'ShuffleV2'])
    parser.add_argument('--path_t', type=str, default="/home/yaof/AdvProp/saved_models/model_best.pth.tar",
    ...
    parser.add_argument('-b', '--beta', type=float, default=0.2, help='weight balance for other losses')
    ...
    parser.add_argument('--self_attn', type=bool, default=False,
                        help='choose when you want to select an attn student model')
    parser.add_argument('--stem', type=bool, default=False,
                        help='choose the stem to be attention model as well or not')
    ...
    opt.model_name = 'S:{}_T:{}_{}_{}_lr:{}_r:{}_a:{}_b:{}_{}_stem:{}_H'.\
        format(opt.model_s, opt.model_t, opt.dataset, opt.distill,
               opt.learning_rate, opt.gamma, opt.alpha, opt.beta, opt.trial, opt.stem)
...
def load_teacher(model_path, n_cls=10):
    print('==> loading teacher model')
    norm_layer = MixBatchNorm2d
    arch = "wide_resnet50_2"
    import net_rectified
    model = net_rectified.__dict__[arch](num_classes=n_cls, norm_layer=norm_layer)
